        ...
        <div className="flex justify-center items-center">
          <div className="flex flex-col gap-6">
            ...
            <BodyText className="text-center">
              Your pets are family, and their journey deserves the highest level
              of care. Based in the Philippines and serving clients worldwide,
              Joyful Pet Transport specializes in safe, stress-free domestic and
              international pet relocation, carefully managing every step of the
              travel process with compassion, expertise, and clear
              communication. From documentation and airline coordination to
              dedicated travel day support, we provide complete peace of mind
            ...
            <div className="flex h-full justify-center items-center">
              <div className="flex flex-col gap-6 w-full">
                ...
                <BodyText>
                  ...
                  level of care. Based in the Philippines and serving clients
                  worldwide, Joyful Pet Transport specializes in safe,
          ...
          <div className="flex h-full justify-center items-center">
            <div className="flex flex-col gap-6 w-full">
              ...
              <BodyText>
                Your pets are family, and their journey deserves the highest
                level of care. Based in the Philippines and serving clients
                worldwide, Joyful Pet Transport specializes in safe, stress-free
                domestic and international pet relocation, carefully managing
                every step of the travel process with compassion, expertise, and
                clear communication. From documentation and airline coordination
                to dedicated travel day support, we provide complete peace of
                mind from departure to arrival.
              </BodyText>
              <div className="flex flex-row gap-6">
                <DynamicButton onPress={() => router.push("/our-services")}>
                  BOOK NOW
