...
const InternationalRelocationFormSchema = z.object({
  ...
  origin_postal_code: z
    .string()
    .min(1, "Please enter the origin postal code"),
  origin_address_country: z
    .string()
    .min(1, "Please enter the origin country"),
  ...
  destination_address_country: z
    .string()
    .min(1, "Please enter the destination country"),
